                      ...
                      <div class="row">
                          ...
                          <form class="form-horizontal" role="form" action="" method="post" autocomplete="off">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-offset-4 col-sm-3">
                                <button type="submit" name="update_current_employee" class="btn btn-sm btn-warning">Update Now</button>
                                <a title="Update Task" href="admin-manage-user.php"><span class="btn btn-sm btn-primary">Cancle</span></a>
                              </div>
                        ...
                        <div class="col-md-5">
                          ...
                          <form action="" method="POST" id="employee_pass_cng">
                            ...
                            <div class="form-group">
                              <button type="submit" name="btn_user_password" class="btn btn-danger">Ok</button>
